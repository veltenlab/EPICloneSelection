...
```{r, required packages}
setwd("/home/abianchi/Documents/CpGs Selection Data/Script Lars/Simulation_test")
rm(list=ls())
require(glmnet)
require(pheatmap)
require(ggplot2)
...
```{r, read data}
data <- read.table("/home/abianchi/Documents/CpGs Selection Data/Approach_3/Version_2/HhaI 1753 CpGs.txt",header = T)
metadata <- read.table("/home/abianchi/Documents/CpGs Selection Data/Approach_3/Version_2/Samples_code_Dynamic_CpGs_v6.txt",sep="\t",header=T, stringsAsFactors = F)
load("/home/abianchi/Documents/CpGs Selection Data/One.vs.all.approach/norm.beta.nov14.Rdata")
...
list1.half.CpGs <- read.table("/home/abianchi/Documents/CpGs Selection Data/Script Lars/Half methylated regions/Hha1.sites.S1.S4.comparisons.not.partially.methylated.S1.S4.CpGs.txt")

list2.half.CpGs <- read.table("/home/abianchi/Documents/CpGs Selection Data/Script Lars/Half methylated regions/Hha1.sites.S1.S4.comparisons.partially.methylated.S1.S4.CpGs.txt")
